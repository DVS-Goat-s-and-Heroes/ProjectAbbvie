...
import os
# --- Alteração 1: Importa dynamic para evitar erro de cache ---
import win32com.client.dynamic as win32 
# --- Alteração 2: Importa pythoncom para evitar erro de thread ---
import pythoncom 
...
class DocFlowApp:
    ...
    def generate_word(self):
        ...
        try:
            ...
            # --- CORREÇÃO 1: Inicializa Threads ---
            pythoncom.CoInitialize()

            # --- CORREÇÃO 2: Usa Dispatch DINÂMICO ---
            # Isso evita o erro "Add.Content" causado por cache corrompido
            ...
            for item in self.files_data:
                ...
                try:
                    # --- CORREÇÃO 3: ÍCONE ---
                    # Removemos o ClassType="AcroExch..."
                    # Isso faz o ícone aparecer usando o padrão do seu Windows
